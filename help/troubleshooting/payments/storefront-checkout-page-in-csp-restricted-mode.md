...
本文針對&#x200B;**[!UICONTROL CSP restricted mode]**&#x200B;中檢視結帳頁面時Adobe Commerce 2.4.7問題提供說明和修正，其中的&quot;*拒絕執行內嵌指令碼，因為它違反下列內容安全性原則指示： &quot;script-src ...*&quot; 瀏覽器主控台記錄檔中的錯誤訊息。
...
**storefront checkout**&#x200B;頁面已損毀或無法載入，因為&#39;&#39;*Refused to execute inline script，因為它違反下列內容安全性原則指示詞： &quot;script-src ...*&#39; 瀏覽器主控台記錄檔中的錯誤訊息。
...
相對應的**[!UICONTROL CSP]**&#x200B;標頭在付款頁面的`script-src`指示詞內未包含`unsafe-inline`關鍵字。此外，僅允許[!DNL whitelisted]個內嵌指令碼。
...
Adobe Commerce和Magento Open Source 2.4.7以及更新版本包含一個**[!UICONTROL Content Security Policy (CSP)]** [!DNL nonce]提供者，以便為每個請求產生唯一的[!DNL nonce]字串。接著會將這[!DNL nonce]個字串附加至[!UICONTROL CSP]標頭。
...
**storefront checkout**&#x200B;頁面上缺少付款方法或付款方法無法運作，且有&#39;&#39;*Refused to execute inline script，因為它違反下列內容安全性原則指示詞： &quot;script-src ...*&#39; 瀏覽器主控台記錄檔中的錯誤訊息。
...
客戶無法下訂單，因為&quot;*Refused to execute inline script，因為它違反下列內容安全性原則指示詞： &quot;script-src ...*&quot; 瀏覽器主控台記錄檔中的錯誤訊息。
