...
* [在Adobe Commerce SaaS Data Export Guide （僅英文版）中檢閱記錄檔並疑難排解Adobe Commerce SaaS資料匯出和同步](https://experienceleague.adobe.com/zh-hant/docs/commerce/saas-data-export/logs-troubleshooting/troubleshooting-logging)
