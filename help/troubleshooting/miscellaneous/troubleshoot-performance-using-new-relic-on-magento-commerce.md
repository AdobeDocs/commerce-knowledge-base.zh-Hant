...
<li>按一下每個個別的交易。 如果無法解決問題，<a href="https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket">請提交支援票證。</a>
</li>
