...
1. 確認[[!UICONTROL indexers]](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/configuration-guide/cli/manage-indexers) （在開發人員檔案中）正在執行，且`Product Feed` [!UICONTROL indexer]已設定為`Update by Schedule`。
1. 確認模組&#x200B;*已啟用*。 `saas-export`中繼資料會安裝下列模組，這些模組都必須是&#x200B;*已啟用*：
