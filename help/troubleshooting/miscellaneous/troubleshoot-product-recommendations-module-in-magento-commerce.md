...
1. 確認[[!UICONTROL indexers]](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/configuration-guide/cli/manage-indexers) （在開發人員檔案中）執行中，且```php    Product Feed    ``` [!UICONTROL indexer]設定為```php    Update by Schedule    ```。
1. 確認模組&#x200B;*已啟用*。 ```php    saas-export    ```中繼資料安裝下列模組，這些模組必須全部為&#x200B;*已啟用*： ```php    "magento/module-catalog-data-exporter"      "magento/module-catalog-inventory-data-exporter"      "magento/module-catalog-url-rewrite-data-exporter"      "magento/module-configurable-product-data-exporter"      "magento/module-data-exporter"      "magento/module-saas-catalog"    ```
...
* 在開發人員檔案中[產品推薦管理員開發](https://experienceleague.adobe.com/zh-hant/docs/commerce-merchant-services/product-recommendations/developer/development-overview)
* 產品推薦指南中的[產品推薦簡介](https://experienceleague.adobe.com/zh-hant/docs/commerce-merchant-services/product-recommendations/overview)
* 在產品推薦指南中[建立產品推薦](https://experienceleague.adobe.com/zh-hant/docs/commerce-merchant-services/product-recommendations/admin/create)
* 在[!DNL SaaS]資料匯出指南中[檢閱記錄檔及疑難排解](https://experienceleague.adobe.com/zh-hant/docs/commerce/saas-data-export/logs-troubleshooting/troubleshooting-logging)
