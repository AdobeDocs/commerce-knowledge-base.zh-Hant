...
* **教學SQL** — 想要使用SQL Report Builder，但您不瞭解SQL？ 沒關係 — 我們舉辦了[教學課程](/docs/commerce-business-intelligence/mbi/analyze/sql/sql-rpt-bldr.html)，協助您掌握基本知識。
...
* **偵錯SQL查詢** — 您有時會遇到非EXPLAIN錯誤，導致查詢無法執行。 建議您參閱[Commerce Intelligence使用手冊：使用SQL Report Builder](/docs/commerce-business-intelligence/mbi/analyze/sql/sql-rpt-bldr.html)和SQL教學課程，協助找出查詢發生錯誤的位置。
