...
MDVA-34330修補程式解決未根據管理員時區篩選訂單的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.0.24。 修補程式ID為MDVA-34330。 請注意，此問題已排程在Adobe Commerce 2.4.3中修正。
...
1. 前往 **商店** >設定> **設定** > **一般** 並設定 **時區** 至 *東部標準時間（美洲/紐約）*
1. UTC00:00後下新訂單
1. 前往 **銷售** > **訂購** 並按今天的日期篩選
