...
MDVA-39195修補程式可解決 **加入購物車** 啟用重新導向至購物車時，「類別」頁面上的按鈕未啟用。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.2。 修補程式ID為MDVA-39195。 請注意，問題已在Adobe Commerce 2.4.3中修正。
...
此 **加入購物車** 啟用重新導向至購物車時，「類別」頁面上的按鈕未啟用。

<u>要再現的步驟</u>：

1. 前往 **商店** >設定> **設定** > **銷售** > **簽出**.
1. 展開 **購物車** 區段。
1. 設定 **新增產品後重新導向至購物車** 變更為是。
1. 造訪類別頁面。
