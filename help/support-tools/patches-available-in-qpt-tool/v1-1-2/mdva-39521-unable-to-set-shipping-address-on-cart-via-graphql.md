...
MDVA-39521修補程式可解決使用者無法透過GraphQL在電話號碼為空白的購物車上設定送貨地址的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.2。 修補程式ID為MDVA-39521。 請注意，此問題已排程在Adobe Commerce 2.4.4中修正。
...
1. 建立簡單的產品。
1. 前往 **商店** > **設定** > **客戶** > **客戶組態** > **名稱和地址選項** 並將「顯示電話」設定為「選擇性」。
