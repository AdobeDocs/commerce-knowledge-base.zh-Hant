...
MDVA-43232修補程式修正依特殊價格排序視覺化銷售器中的產品至頂端（或底部）時，導致儲存類別時發生錯誤的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.12。 修補程式ID為MDVA-43232。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
...
1. 確定有兩個網站。
1. 瀏覽至 **商店** > **設定** > **目錄** > **價格** 並設定目錄價格範圍=網站。
1. 再次，瀏覽至 **商店** > **設定** > **目錄** > **Visual Merchandiser** > **類別規則的可見屬性** >並新增特別價格。
1. 建立簡單產品並將產品指派給兩個網站。
1. 新增特殊價格至產品的預設範圍。
