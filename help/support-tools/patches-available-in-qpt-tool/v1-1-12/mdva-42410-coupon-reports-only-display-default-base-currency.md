...
MDVA-42410修補程式修正了抵用券報表僅顯示基本貨幣的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.12。 修補程式ID為MDVA-42410。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
...
1. 前往 **商店** > **貨幣匯率** 並將匯率設定為 **歐元**.
1. 建立 **購物車價格規則** 含特定優惠券 —  **測試**.
1. 前往前端，使用 **測試** 新網站的優惠券。
1. 前往 **報表** > **銷售** > **優惠券**.
1. 在「範圍」下拉式清單中選取新網站。
1. 重新整理統計資料並執行報表。
