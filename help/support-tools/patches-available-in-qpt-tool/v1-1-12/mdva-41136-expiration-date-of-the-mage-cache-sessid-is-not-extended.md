...
MDVA-41136修補程式解決`mage-cache-sessid` Cookie的到期日未延長，進而導致客戶資料清理的問題。 安裝[品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.12時，即可使用此修補程式。 修補程式ID為MDVA-41136。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
