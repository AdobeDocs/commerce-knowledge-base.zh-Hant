...
MDVA-43414修補程式可解決執行 `inventory.reservations.updateSalabilityStatus` 數值SKU上的消費者佇列。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.12。 修補程式ID為MDVA-43414。 請注意，問題已在Adobe Commerce 2.4.2中修正。
