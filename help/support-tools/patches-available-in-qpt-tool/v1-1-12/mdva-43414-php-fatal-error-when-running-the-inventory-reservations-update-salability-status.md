...
MDVA-43414修補程式可解決在數值SKU上執行`inventory.reservations.updateSalabilityStatus`佇列取用者時所發生的PHP嚴重錯誤。 安裝[品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.12時，即可使用此修補程式。 修補程式ID為MDVA-43414。 請注意，問題已在Adobe Commerce 2.4.2中修正。
