...
ACSD-51792修補程式修正了以下情況下的頁面沒有印象事件的效能問題： [!DNL Google Tag Manager] 4已啟用。 此修補程式適用於 [!DNL Quality Patches Tool (QPT)] 已安裝1.1.33。 修補程式ID為ACSD-51792。 請注意，問題已在Adobe Commerce 2.4.6中修正。
...
頁面在下列情況下沒有曝光事件 [!DNL Google Tag Manager] 4已啟用。
...
1. 前往 [Google標籤助理](https://tagassistant.google.com/)，並完成連線至網站所需的步驟。
1. 開啟店面上有產品清單的類別頁面。
1. 在「標籤助理觀察」中檢查曝光數事件。
