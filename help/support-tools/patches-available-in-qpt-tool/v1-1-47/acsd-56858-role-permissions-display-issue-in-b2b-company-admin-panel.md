...
ACSD-56858修補程式修正B2B環境中受限制公司管理員的角色許可權顯示不正確的問題。 此修補程式適用於 [!DNL Quality Patches Tool (QPT)] 已安裝1.1.47。 修補程式ID為ACSD-56858。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
...
1. 瀏覽至 **[!UICONTROL Roles and permission]** 並編輯角色。
