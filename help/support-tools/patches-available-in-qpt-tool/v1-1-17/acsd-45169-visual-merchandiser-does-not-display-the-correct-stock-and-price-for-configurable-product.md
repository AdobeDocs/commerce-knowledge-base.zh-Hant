...
ACSD-45169修補程式修正了以下問題：套用測試版更新後，Visual Merchandiser無法針對可設定產品顯示正確的庫存和價格。 安裝[品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.17時，即可使用此修補程式。 修補程式ID為ACSD-45169。 請注意，此問題已排程在Adobe Commerce 2.4.6中修正。
