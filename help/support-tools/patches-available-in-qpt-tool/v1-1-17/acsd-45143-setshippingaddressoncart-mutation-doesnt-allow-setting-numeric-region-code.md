...
ACSD-45143修補程式修正setShippingAddressesOnCart突變不允許將數值地區碼設為「region」的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.17。 修補程式ID為ACSD-45143。 請注意，此問題已排程在Adobe Commerce 2.4.6中修正。
...
1. 傳送要求以將送貨地址設定為購物車。
   ...
   注意：在此範例中，國家/地區代碼設為「FR」，而地區代碼設為「58」。 根據 `directory_country_region` 資料庫表格，區域碼58為「Nievre」。
