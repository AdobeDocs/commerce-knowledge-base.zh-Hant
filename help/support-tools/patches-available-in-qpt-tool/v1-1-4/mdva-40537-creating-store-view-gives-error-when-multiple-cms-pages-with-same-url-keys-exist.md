...
description: MDVA-40537修補程式修正使用者建立存放區檢視時，若多個CMS頁面具有相同URL金鑰會發生錯誤的問題。 安裝[Quality Patches Tool (QPT)](https://experienceleague.adobe.com/en/docs/commerce-operations/upgrade-guide/patches/overview) 1.1.4時，即可使用此修補程式。 修補程式ID為MDVA-40537。 請注意，問題已在Adobe Commerce 2.4.1中修正。
...
MDVA-40537修補程式修正使用者建立存放區檢視時，若多個CMS頁面具有相同URL金鑰會發生錯誤的問題。 安裝[品質修補工具(QPT)](https://experienceleague.adobe.com/en/docs/commerce-operations/upgrade-guide/patches/overview) 1.1.4時，即可使用此修補程式。 修補程式ID為MDVA-40537。 請注意，問題已在Adobe Commerce 2.4.1中修正。
