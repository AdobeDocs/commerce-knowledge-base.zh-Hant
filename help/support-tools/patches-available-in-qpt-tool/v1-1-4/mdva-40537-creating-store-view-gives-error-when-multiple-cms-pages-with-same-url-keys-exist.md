...
MDVA-40537修補程式修正了在多個CMS頁面具有相同URL金鑰的情況下，使用者建立存放區檢視時出現錯誤的問題。 安裝[品質修補工具(QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 1.1.4時，即可使用此修補程式。 修補程式ID為MDVA-40537。 請注意，問題已在Adobe Commerce 2.4.1中修正。
