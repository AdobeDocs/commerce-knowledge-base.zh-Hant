...
GraphQL MC-42528修補程式解決了 `categoryList` 當特定類別的瀏覽類別設定為「拒絕」時，會傳回指派和未指派的類別。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.4。 修補程式ID為MC-42528。 請注意，此問題已排程在Adobe Commerce 2.4.4中修正。
...
GraphQL查詢 `categoryList` 傳回指派和未指派的類別。
...
1. 執行 `categoryList` 或 `categories` 以公司使用者身分進行GraphQL查詢。
