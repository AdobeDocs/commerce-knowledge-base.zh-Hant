...
description: MDVA-37748修補程式修正GraphQL查詢傳回未指派給共用目錄之產品的問題。 安裝[Quality Patches Tool (QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 1.1.5時，即可使用此修補程式。 修補程式ID為MDVA-37748。 請注意，此問題已排程在Adobe Commerce 2.4.4中修正。
...
MDVA-37748修補程式修正GraphQL查詢傳回未指派給共用目錄之產品的問題。 此修補程式適用於 [品質修補工具(QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 已安裝1.1.5。 修補程式ID為MDVA-37748。 請注意，此問題已排程在Adobe Commerce 2.4.4中修正。
...
1. 新增標頭 **授權權杖的持有者值** 並執行下列GraphQL查詢：
