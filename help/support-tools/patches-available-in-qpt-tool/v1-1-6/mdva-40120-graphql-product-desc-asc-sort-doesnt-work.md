...
MDVA-40120修補程式解決了GraphQL依DESC/ASC排序時，無法搭配具有相同關聯性或價格的產品運作的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.6。 修補程式ID為MDVA-40120。 請注意，此問題已排程在Adobe Commerce 2.4.4中修正。
...
1. 檢查回應。
1. 變更排序順序 **升冪** 至 **DESC** 在GraphQL查詢中：
   <pre>
    <code class="language-graphql">
    {
