...
MDVA-41597修補程式修正了使用GraphQL將多個可設定產品新增至購物車時，使用者收到錯誤的問題。 此修補程式適用於 [品質修補工具(QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) 已安裝1.1.6。 修補程式ID為MDVA-41597。 請注意，此問題已排程在Adobe Commerce 2.4.4中修正。
...
使用GraphQL變異將多個可設定的產品新增到購物車： `addConfigurableProductsToCart`.
