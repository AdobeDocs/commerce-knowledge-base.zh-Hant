...
MDVA-40830修補程式修正了下單期間多次套用商店點數的問題。 安裝[品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.11時，即可使用此修補程式。 修補程式ID為MDVA-40830。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
