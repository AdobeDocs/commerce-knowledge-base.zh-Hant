...
MDVA-45781修補程式可解決行動裝置上未顯示商店前端搜尋欄位的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.19。 修補程式ID為MDVA-45781。 請注意，問題已在Adobe Commerce 2.4.3中修正。
...
1. 前往Commerce管理員> **商店** > **設定** > **目錄** > **目錄搜尋** 並設定：
   * 啟用Recommendations搜尋，以 *否*
   * 啟用搜尋建議至 *否*
1. 按一下 **儲存設定** 按鈕。
1. 清除快取。
