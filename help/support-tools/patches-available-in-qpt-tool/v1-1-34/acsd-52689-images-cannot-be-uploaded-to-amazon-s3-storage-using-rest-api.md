...
ACSD-52689修補程式修正無法使用REST API將影像上傳至Amazon S3儲存空間的問題。此修補程式適用於 [!DNL Quality Patches Tool (QPT)] 已安裝1.1.34。 修補程式ID為ACSD-52689。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
