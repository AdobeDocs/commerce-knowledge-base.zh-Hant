...
ACSD-49574修補程式修正無法透過GraphQL更新購物車中的禮品卡產品的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.28時，即可使用此修補程式。 修補程式ID為ACSD-49574。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
