...
MDVA-38526修補程式解決管理員使用者無法存取SWAT工具的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.9。 修補程式ID為MDVA-38526。 請注意，此問題已排程在Adobe Commerce 2.4.4中修正。
...
500錯誤是由以下錯誤記錄檔觸發： *無法取消序列化值。 錯誤：語法錯誤*.
