...
MDVA-38346修補程式解決當Adobe Commerce時區與本機環境時區不同時，日期篩選器無法正常運作的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.9。 修補程式ID為MDVA-38346。 請注意，此問題已排程在Adobe Commerce 2.4.4中修正。
...
1. 下幾個訂單。
1. 為他們建立商業發票。
1. 前往 **銷售** > **發票** 並依「發票日期」（目前日期 — 目前日期）篩選。
1. 檢查日期。
