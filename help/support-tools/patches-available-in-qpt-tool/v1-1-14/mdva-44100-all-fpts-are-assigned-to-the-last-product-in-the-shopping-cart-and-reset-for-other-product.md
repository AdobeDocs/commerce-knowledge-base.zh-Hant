...
MDVA-44100修補程式解決所有FPT指派給購物車中最後一個產品的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.14。 修補程式ID為MDVA-44100。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
...
1. 前往 **商店** > **設定** > **銷售** > **稅金** 並設定：
   * 啟用FPT =是
   * 沖銷稅捐至FPT =是
   * 小計中包含FPT =是
1. 前往 **商店** > **屬性** > **產品**，並以「型別=固定產品稅捐」建立新屬性。
1. 將屬性新增至屬性集。
