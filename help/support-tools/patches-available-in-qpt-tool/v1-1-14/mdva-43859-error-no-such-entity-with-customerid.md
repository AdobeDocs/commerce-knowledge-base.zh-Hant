...
MDVA-43859修補程式修正了錯誤的問題 *沒有具有customerId =* 當已刪除的客戶嘗試登入時記錄。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.14。 修補程式ID為MDVA-43859。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
...
錯誤 *沒有具有customerId =* 當已刪除的客戶嘗試登入時記錄。
