...
MDVA-44505修補程式解決以下問題：套用獎勵點的購物車的GraphQL查詢沒有考慮獎勵點，並傳回不正確的總計。 安裝[品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.14時，即可使用此修補程式。 修補程式ID為MDVA-44505。 請注意，問題已在Adobe Commerce 2.4.3中修正。
