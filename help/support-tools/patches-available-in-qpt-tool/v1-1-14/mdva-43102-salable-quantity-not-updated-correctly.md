...
MDVA-43102修補程式修正透過REST API完成退款時，可銷售數量未正確更新的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.14。 修補程式ID為MDVA-43102。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
...
1. 使用下列裝載提交REST請求以退款發票：
   ...
   * 離線方法/訂單/`<order_id>`/refall
   * 線上方法/發票/`<invoice_id>`/refall
