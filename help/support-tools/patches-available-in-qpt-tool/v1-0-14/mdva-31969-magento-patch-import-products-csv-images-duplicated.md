...
MDVA-31969修補程式修正了匯入兩個產品.csv檔案時影像重複的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.0.14。
...
新產品影像建立於 `pub/media` 資料夾，即使匯入產品時已存在相同的影像。

<u>要再現的步驟</u>：

1. 建立影像目錄： `mkdir var/import-images`
1. 在路徑內新增影像 `<install dir>/var/import-images`.
1. 匯入產品.csv檔案兩次。
