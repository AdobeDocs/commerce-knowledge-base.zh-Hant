...
ACSD-54376修補程式修正了當產品在加入購物車後從[!UICONTROL shared catalog]中移除時，購物車中發生例外狀況的問題。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.41時，即可使用此修補程式。 修補程式ID為ACSD-54376。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
