...
ACSD-52133修補程式修正了升級後無法儲存客戶帳戶的問題。 此修補程式適用於 [!DNL Quality Patches Tool (QPT)] 已安裝1.1.35。 修補程式ID為ACSD-52133。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
...
1. 設定加密金鑰，如下所示 `env.php`：

   `d337b914e91ff703b1e94ba4156aadf0`

1. 將以下值設定到資料庫中，以供下列的任何客戶使用 `customer_entity` 表格：
