...
ACSD-51265修補程式修正了 `catalog_product_price` 當系統中捆綁的產品過多時，重新索引效能會很低。 此修補程式適用於 [!DNL Quality Patches Tool (QPT)] 已安裝1.1.35。 修補程式ID為ACSD-51265。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
...
1. 產生至少具有下列條件的目錄： *10,000* 隨附動態價格選項的產品。
1. 執行產品價格重新索引。
