...
MDVA-44940修補程式修正從管理員儲存類別時發生SQL錯誤的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.16。 修補程式ID為MDVA-44940。 請注意，此問題已排程在Adobe Commerce 2.4.6中修正。
...
1. 建立指派給第二個網站的測試產品。
1. 前往 **管理員** > **目錄** > **類別**，選取 **範圍** = **第二個網站** 並前往 **類別中的產品** > **自動排序** >將無庫存產品移至底部，然後按一下 **儲存**.
