...
MDVA-43935修補程式修正了在產品頁面上顯示兩次追加銷售產品的問題。 安裝[品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.13時，即可使用此修補程式。 修補程式ID為MDVA-43935。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
