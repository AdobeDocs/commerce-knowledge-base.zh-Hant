...
MDVA-42969修補程式修正了只有當客戶區段設為全部時，相關產品規則才能運作的問題。 此修補程式適用於 [品質修補工具(QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安裝1.1.13。 修補程式ID為MDVA-42969。 請注意，此問題已排程在Adobe Commerce 2.4.5中修正。
...
1. 前往 **商店** > **設定** > **目錄** > **規則型產品關係** 並設定 **顯示相關產品** = **僅限規則型**.
1. 前往 **客戶** > **區段** 並建立新區段： **套用到** = **訪客與註冊客戶**.
1. 前往 **行銷** > **相關產品規則** 並建立新規則。
...
1. 修改在步驟三中建立的規則並設定 **客戶區段** = **特定** > **區段** 步驟2.
1. 在店面開啟相符的產品。
