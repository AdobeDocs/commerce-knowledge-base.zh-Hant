...
ACSD-47657修補程式修正了高載入AWS S3請求期間發生的問題，方法是新增AWS憑證的快取機制。 安裝[[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.39時，即可使用此修補程式。 修補程式ID為ACSD-47657。 請注意，此問題已排程在Adobe Commerce 2.4.7中修正。
