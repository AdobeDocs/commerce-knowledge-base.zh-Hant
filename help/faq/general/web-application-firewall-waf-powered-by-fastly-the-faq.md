...
在[Adobe Commerce說明中心](https://experienceleague.adobe.com/zh-hant/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket)提交支援票證[。 &#x200B;](https://support.magento.com)請包含以指出票證與WAF服務相關，並包含封鎖的請求識別碼(ID)。
