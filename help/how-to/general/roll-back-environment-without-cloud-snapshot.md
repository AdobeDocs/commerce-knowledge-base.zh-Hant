...
在開發人員檔案中檢閱商店設定的[組態管理](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure-store/store-settings.html?lang=zh-Hant)，以進一步瞭解組態管理。
